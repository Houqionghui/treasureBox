...
(function ($) {
    ...
    $.fn.wizzy = function (options) {
        ...
        return this.each(function () {
            ...
            //     var data = $('input:radio[name="back"]:checked').map(function () {
            //         return $(this).val();
            //     }).get().join(",");
            //     //弹出结果
            //     console.log(data);
            //     var data = $('input:radio[name="back1"]:checked').map(function () {
            //         return $(this).val();
            //     }).get().join(",");
            //     //弹出结果
            //     console.log(data);
            //     var data = $('input:radio[name="back2"]:checked').map(function () {
            //         return $(this).val();
            //     }).get().join(",");
            //     //弹出结果
            //     console.log(data);
            //     var data = $('input:radio[name="back3"]:checked').map(function () {
            //         return $(this).val();
            //     }).get().join(",");
            //     //弹出结果
            //     console.log(data);
            //     var data = $('input:radio[name="back4"]:checked').map(function () {
            //         return $(this).val();
            //     }).get().join(",");
            //     //弹出结果
            //     console.log(data);
            //     var data = $('input:radio[name="back5"]:checked').map(function () {
            //         return $(this).val();
            //     }).get().join(",");
            //     //弹出结果
            //     console.log(data);
            //     var data = $('input:radio[name="back6"]:checked').map(function () {
            //         return $(this).val();
            //     }).get().join(",");
            //     //弹出结果
            //     console.log(data);
                
            //     var data = $('input:radio[name="back7"]:checked').map(function () {
            //         return $(this).val();
            //     }).get().join(",");
            //     //弹出结果
            //     console.log(data);
            ...
            function check() {
                ...
                $(document).ready(function(){
                    ...
                    // var param0 = $("input:radio[name='back']:checked").val();
                    // console.log("param0:"+param0);
